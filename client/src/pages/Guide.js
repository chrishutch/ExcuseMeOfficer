...
const Guide = () =>
    <div>
        <Hero backgroundImage="./images/pulledover.jpg">
    ...
    <Container style={{ marginTop: 30 }}>
      <Row>
        <Col size="md-12">
            <h2 id="htwo">Police Stops</h2>
            <h3>What to Do If You Are Pulled Over:</h3>
            <br />
            <ul>
                <li><h3>Keep your Hands in View on the Steering Wheel.</h3></li>
            </ul>
          <p>
